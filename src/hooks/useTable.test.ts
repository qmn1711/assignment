...
describe('useTable with sorts', () => {
  test('should return table output correctly, with sort one column', () => {
    ...
    expect(firstColumn.getHeaderProps().style).toMatchObject(
  ...
  test('should return table output correctly, with sort two columns', () => {
    ...
    const [firstRowFirstCell, firstRowSecondCell] =
      result.current.rows[0].cells;
    const [secondRowFirstCell, secondRowSecondCell] =
      result.current.rows[1].cells;
    const [thirdRowFirstCell, thirdRowSecondCell] =
      result.current.rows[2].cells;
    ...
    expect(result.current.sorts).toMatchObject([
      sortFirstColumn,
      sortSecondColumn,
    ]);
    expect(result.current.filters.length).toBe(0);
...
describe('useTable with filters', () => {
  ...
  test('should return table output correctly, with filter two columns', () => {
    ...
    const [firstRowFirstCell, , firstRowThirdCell] =
      result.current.rows[0].cells;
...
describe('useTable with sorts and filters', () => {
  test('should return table output correctly', () => {
    ...
    expect(secondColumn.getHeaderProps().style).toMatchObject(
      DefaultHeaderColumnStyle
    );
